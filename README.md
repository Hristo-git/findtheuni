...
- 🎓 **84 Universities** from 23 European countries with detailed info (16 in Spain: QS 2026 ranks, per-region tuition, teaching languages)
...
├── data/
│   ├── universities.js  # 84 universities with coords, programs, CoL
