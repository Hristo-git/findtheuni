...
export const careerOutcomes = {
  ...
  "Словения":    { salary1y: 21000, salary3y: 27000, salary5y: 34000, topIndustries: ["Pharma","Automotive","IT"], unemployment: 3.7 },
...
export const scholarships = [
  { id: 1, name: "Erasmus+", country: "EU", amount: "€800–1200/мес", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "Февруари", url: "erasmusplus.bg", desc: "Програма на ЕС за мобилност. Покрива пътуване + месечна стипендия.", flag: "🇪🇺", eu: "yes", euNote: "България е пълноправен участник в Erasmus+." },
  { id: 2, name: "DAAD Стипендия", country: "Германия", amount: "€934/мес", fields: ["Всички"], level: ["Магистър", "Докторат"], deadline: "Октомври", url: "daad.de", desc: "Германска академична служба – пълна стипендия за Германия.", flag: "🇩🇪", eu: "yes", euNote: "DAAD е отворена за всички националности." },
  { id: 3, name: "Chevening", country: "UK", amount: "Пълна", fields: ["Всички"], level: ["Магистър"], deadline: "Ноември", url: "chevening.org", desc: "Престижна британска правителствена стипендия. Покрива всичко.", flag: "🇬🇧", eu: "yes", euNote: "Chevening приема кандидати от България." },
  { id: 4, name: "Holland Scholarship", country: "Нидерландия", amount: "€5000", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "Февруари", url: "studyinholland.nl", desc: "За не-EU студенти в нидерландски университети.", flag: "🇳🇱", eu: "no", euNote: "Само за студенти извън ЕИП. Български граждани НЕ отговарят на условията." },
  { id: 5, name: "Swiss Excellence", country: "Швейцария", amount: "CHF 1920/мес", fields: ["Всички"], level: ["Докторат", "Пост-док"], deadline: "Август", url: "sbfi.admin.ch", desc: "Швейцарска правителствена стипендия за изследователи.", flag: "🇨🇭", eu: "yes", euNote: "Отворена за изследователи от България." },
  { id: 6, name: "SI Scholarship", country: "Швеция", amount: "SEK 10000/мес", fields: ["Всички"], level: ["Магистър"], deadline: "Февруари", url: "si.se", desc: "Swedish Institute стипендия – покрива такси + издръжка.", flag: "🇸🇪", eu: "no", euNote: "Гражданите на EU/ЕИП са изрично изключени. Важи за 34 определени държави." },
  { id: 7, name: "Eiffel Excellence", country: "Франция", amount: "€1181/мес", fields: ["Инженерство", "IT", "Право", "Икономика"], level: ["Магистър", "Докторат"], deadline: "Януари", url: "campusfrance.org", desc: "Френска правителствена стипендия за топ студенти.", flag: "🇫🇷", eu: "check", euNote: "Отворена за чужди граждани, но приоритет имат кандидатите извън EU." },
  { id: 8, name: "Italian Gov. Scholarship", country: "Италия", amount: "€900/мес", fields: ["Всички"], level: ["Магистър", "Докторат"], deadline: "Юни", url: "esteri.it", desc: "Италианска правителствена стипендия за чужденци.", flag: "🇮🇹", eu: "yes", euNote: "Отворена за чуждестранни граждани, включително от EU." },
  { id: 9, name: "Visegrad Fund", country: "ЦЕ", amount: "€2300/семестър", fields: ["Всички"], level: ["Магистър"], deadline: "Март", url: "visegradfund.org", desc: "За студенти от/към Вишеградските държави (PL, CZ, SK, HU).", flag: "🏛️", eu: "yes", euNote: "България участва като съседна държава по програмите на фонда." },
  { id: 10, name: "Fulbright Bulgaria", country: "САЩ/БГ", amount: "Пълна", fields: ["Всички"], level: ["Магистър", "Докторат"], deadline: "Октомври", url: "fulbright.bg", desc: "Престижна американска стипендия за български студенти.", flag: "🇺🇸", eu: "yes", euNote: "Специално за български граждани." },
  { id: 11, name: "Gates Cambridge", country: "UK", amount: "Пълна", fields: ["Всички"], level: ["Магистър", "Докторат"], deadline: "Декември", url: "gatescambridge.org", desc: "Една от най-престижните в света – за Cambridge.", flag: "🎓", eu: "yes", euNote: "Отворена за всички националности извън UK." },
  { id: 12, name: "Stipendium Hungaricum", country: "Унгария", amount: "€130-390/мес", fields: ["Всички"], level: ["Бакалавър", "Магистър", "Докторат"], deadline: "Януари", url: "stipendiumhungaricum.hu", desc: "Унгарска правителствена стипендия – без такси.", flag: "🇭🇺", eu: "check", euNote: "Само за държави с двустранно споразумение с Унгария — провери дали България е в списъка за годината." },
  { id: 13, name: "CEEPUS", country: "ЦЕ", amount: "€300-500/мес", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "Юни/Ноември", url: "ceepus.info", desc: "Мобилност между ЦЕ университети.", flag: "🏛️", eu: "yes", euNote: "България е страна членка на CEEPUS." },
  { id: 14, name: "GKS Scholarship", country: "Южна Корея", amount: "Пълна", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "Март", url: "studyinkorea.go.kr", desc: "Корейска правителствена стипендия – пълно покритие.", flag: "🇰🇷", eu: "yes", euNote: "Отворена за български граждани." },
  { id: 15, name: "МОН Стипендия", country: "България", amount: "250-600 лв/мес", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "Целогодишно", url: "mon.bg", desc: "Стипендии от МОН за отлични резултати.", flag: "🇧🇬", eu: "yes", euNote: "За студенти в български университети." },
  { id: 16, name: "Beca MEC", country: "Испания", amount: "€1,700 + €1,600 + такса", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "7 април – 18 май", url: "becaseducacion.gob.es", desc: "Испанската държавна стипендия: фиксирана част по доход (€1,700), част за живеене далеч от дома (€1,600), пълно покриване на таксата и променлива част до ~€2,800 според оценките.", flag: "🇪🇸", eu: "yes", euNote: "EU граждани, записани в официална програма в Испания, отговарят наравно с испанците." },
  { id: 17, name: "DSU — регионална стипендия", country: "Италия", amount: "€7,171/год", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "Юли–септември", url: "regionalna агенция (ER.GO, DiSCo…)", desc: "За студенти с ISEE под €28,340: стипендия за живеещи далеч от дома, пълно освобождаване от такси и достъп до субсидирано общежитие. Кандидатства се в регионалната агенция, не в университета.", flag: "🇮🇹", eu: "yes", euNote: "EU граждани кандидатстват наравно с италианците; доходът се доказва с ISEE parificato." },
  { id: 18, name: "SU — датска стипендия", country: "Дания", amount: "DKK 6,600–7,400/мес", fields: ["Всички"], level: ["Бакалавър", "Магистър"], deadline: "Целогодишно", url: "su.dk", desc: "Датската държавна помощ за студенти. EU граждани получават право на нея, ако работят 10–12 часа седмично в Дания (статут на работник).", flag: "🇩🇰", eu: "yes", euNote: "Изисква се работа 10–12ч/седмица, за да се придобие статут на работник." },
  { id: 19, name: "APL — жилищна помощ", country: "Франция", amount: "€100–200/мес", fields: ["Всички"], level: ["Бакалавър", "Магистър", "Докторат"], deadline: "След наемане на жилище", url: "caf.fr", desc: "Френската жилищна помощ сваля наема с €100–200 месечно. Не е стипендия по успех — полага се на всеки студент с договор за наем.", flag: "🇫🇷", eu: "yes", euNote: "Отворена за EU студенти веднага след настаняване; иска се договор за наем и банкова сметка." },
  { id: 20, name: "Национална програма NSP", country: "Словакия", amount: "до €1,470/мес", fields: ["Всички"], level: ["Магистър", "Докторат"], deadline: "30 април", url: "scholarships.sk", desc: "Словашка програма за престой от 1 до 10 месеца — обучение, изследване или творчески проект. Отворена за всички освен словашки граждани.", flag: "🇸🇰", eu: "yes", euNote: "Отворена за всички националности освен словашка." },
  { id: 21, name: "Стипендии на МВнР", country: "Румъния", amount: "Такса + €65–85/мес", fields: ["Всички"], level: ["Бакалавър", "Магистър", "Докторат"], deadline: "16 февруари – 31 март", url: "studyinromania.gov.ro", desc: "Румънска правителствена стипендия: покрива такса, общежитие и месечна издръжка.", flag: "🇷🇴", eu: "no", euNote: "Само за граждани извън EU. Българите вместо това се конкурират за държавно субсидираните места наравно с румънците." },
];
